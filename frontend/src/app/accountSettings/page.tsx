...
export default function AccountSettingsLayout() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen w-full bg-[#F2F5F7] rounded-[0.125rem] flex items-center justify-center">
        <div className="flex items-center">
          <div className="loading loading-spinner loading-lg"></div>
          <span className="ml-4 text-[#2C3E50] text-lg">Loading account settings...</span>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen w-full bg-[#F2F5F7] rounded-[0.125rem] flex items-start justify-center">
      <div className="w-[75rem] rounded-[3.75rem] bg-white mt-8 mb-12 p-12 flex shadow min-h-[40rem]">
        ...
        <div className="w-[13.1875rem] flex flex-col items-center pt-8 h-full">
          {/* Avatar Frame */}
          <div className="relative w-[9.375rem] p-[2.5rem] rounded-[12.5rem] bg-white shadow-[0_0.0625rem_0.125rem_0_#7C94AF14,0_0.125rem_0.25rem_0_#7C94AF1F] mb-4 flex items-center justify-center overflow-hidden">
            {profileImage ? (
              <img 
                src={profileImage} 
                alt="Profile" 
