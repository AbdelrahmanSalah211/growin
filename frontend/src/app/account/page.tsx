...
import PaymentMethodsTab from "../../components/accountSettings/PaymentMethodsTab";
...
export default function AccountSettingsLayout() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#F2F5F7] rounded-[0.125rem] flex items-start justify-center">
      <div className="w-[75rem] rounded-[3.75rem] bg-white mt-[9.6875rem] p-12 flex shadow min-h-[40rem]">
        {/* Sidebar */}
